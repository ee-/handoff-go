...
REQUIRED_TEXT = {
    ...
    SKILL_ROOT / "references/update.md": (
        ...
        "One-time migration",
        "Next Actor: ARCHITECT",
        "not** a durable protocol state",
        "never carries update",
        "is never reset",
        "working tree is input, never",
        "update.mjs run",
    ...
    SKILL_ROOT / "update.mjs": (
        ...
        "export function resolveTrusted",
        "export function materializePinned",
        "export function resolveTrustedUpdater",
        'ev.result = "PREPARED"',
        "workingTreeIsAuthority: false",
        "names default branch",
        "resolves to the repository root",
        "already exists and is not a recognized durable proposal",
